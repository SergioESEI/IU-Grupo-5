...
--
-- Servidor: localhost
-- Tiempo de generación: 17-11-2016 a las 16:38:37
...
ALTER TABLE `Reserva_Espacio`
 ADD PRIMARY KEY (`Id_Reserva`), ADD UNIQUE KEY `DNI_Reserva` (`DNI_Reserva`), ADD KEY `Id_Espacio` (`Id_Espacio`);
...
--
ALTER TABLE `Usuario`
ADD CONSTRAINT `Usuario_ibfk_3` FOREIGN KEY (`Usuario`) REFERENCES `Trabajador` (`DNI`) ON DELETE CASCADE ON UPDATE CASCADE,
