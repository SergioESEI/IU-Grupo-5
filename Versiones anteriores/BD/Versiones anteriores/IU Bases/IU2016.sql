...
--
-- Servidor: localhost
-- Tiempo de generación: 15-11-2016 a las 20:18:06
...
CREATE TABLE IF NOT EXISTS `Inscripcion` (
  ...
  `Id_Actividad` varchar(9) COLLATE latin1_spanish_ci NOT NULL,
  `Id_Cobro` varchar(9) COLLATE latin1_spanish_ci NOT NULL,
  `Fecha` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
