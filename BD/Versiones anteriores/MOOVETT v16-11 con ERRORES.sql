...
CREATE TABLE IF NOT EXISTS `Actividad` (
  `Id_Actividad` int(10) COLLATE latin1_spanish_ci NOT NULL,
  `Nombre` varchar(20) COLLATE latin1_spanish_ci NOT NULL,
  `DNI_Trabajador` varchar(9) COLLATE latin1_spanish_ci NOT NULL,
  `Id_Espacio` int(10) COLLATE latin1_spanish_ci NOT NULL,
  ...
  `Id_Calendario` int(10) COLLATE latin1_spanish_ci NOT NULL
...
CREATE TABLE IF NOT EXISTS `Caja` (
  `Id_Caja` int(10) COLLATE latin1_spanish_ci NOT NULL,
  `Fecha` date NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Cobro` (
  `Id_Cobro` int(10) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Descuento` (
  `Id_Descuento` int(10) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Documento` (
  `DNI` varchar(9) COLLATE latin1_spanish_ci NOT NULL,
  `Tipo_Documento` enum ('SEPA','Proteccion de datos') COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Horario` (
  `Id_Horario` int(10) COLLATE latin1_spanish_ci NOT NULL,
  `Id_Calendario` int(10) COLLATE latin1_spanish_ci NOT NULL,
  `Hora_Inicio` time NOT NULL,
  `Hora_Fin` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `Jornada` (
  ...
  `Libre` varchar(100) COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `Lesion` (
  `DNI` varchar(9) COLLATE latin1_spanish_ci NOT NULL,
  `Id_Lesion` int(10) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Linea_Factura` (
  `Id_Factura` int(10) COLLATE latin1_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Masaje` (
  `Id_Masaje` int(10) COLLATE latin1_spanish_ci NOT NULL,
  `Nombre` varchar(50) COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `Reserva_Espacio` (
  `Id_Reserva` int(10) COLLATE latin1_spanish_ci NOT NULL,
  `Id_Espacio` int(10) COLLATE latin1_spanish_ci NOT NULL,
  `DNI` varchar(9) COLLATE latin1_spanish_ci NOT NULL,
  `Hora_Inicio` time NOT NULL,
  `Hora_Fin` time NOT NULL,
...
ALTER TABLE `Cliente_Externo`
 ADD PRIMARY KEY (`DNI`), ADD UNIQUE KEY `Direccion` (`Direccion`), ADD UNIQUE KEY `Direccion_2` (`Direccion`);
...
ALTER TABLE `Reserva_Espacio`
 ADD PRIMARY KEY (`Id_Reserva`,`DNI`), ADD KEY `Id_Espacio` (`Id_Espacio`);
