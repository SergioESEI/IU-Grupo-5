						...
						<form class="form-horizontal" role="form" action="../controllers/CONTROLADOR_Controller.php?id=altaControlador" method="POST">
							<div class="form-group">
								...
								<div class="form-group">
									  ...
									  <div class="col-sm-4">
										  <input type="text" class="form-control" name="accion" pattern="[A-ZÑña-zÁÉÍÓÚáéíóú]{3,30}" title="<?php echo $strings['error accion']; ?>" required>
									  </div>
								</div>
								
								<!-- Submit que envía en controlador y acción (funcionalidad) a añadir -->
								 <div class="form-group">
